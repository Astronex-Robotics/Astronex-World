...
from utils.sp.parallel_state import (
    get_sp_group,
    get_sp_world_size,
...
class ParallelDims:
    """
    Shim that wraps trainer.distributed.parallel_state's GroupCoordinator API
    to provide the interface expected by sub/CleanCode's attention.py.
    """
