...
from utils.sp import envs
from utils.sp.device_communicators.base_device_communicator import (
    DeviceCommunicatorBase)
from utils.sp.device_communicators.cpu_communicator import (
    CpuCommunicator)
from utils.sp.utils import StatelessProcessGroup
from utils.sp.logger import init_logger
...
class GroupCoordinator:
    ...
    def __init__(
        ...
        if use_device_communicator and self.world_size > 1:
            from utils.sp.device_communicators.cuda_communicator import (
                CudaCommunicator)
